...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/sorting/bubble_sort.o \
...
${OBJECTDIR}/sorting/bubble_sort.o: sorting/bubble_sort.cpp
	${MKDIR} -p ${OBJECTDIR}/sorting
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sorting/bubble_sort.o sorting/bubble_sort.cpp

${OBJECTDIR}/sorting/insertion_sort.o: sorting/insertion_sort.cpp
	${MKDIR} -p ${OBJECTDIR}/sorting
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sorting/insertion_sort.o sorting/insertion_sort.cpp

${OBJECTDIR}/sorting/selection_sort.o: sorting/selection_sort.cpp
	${MKDIR} -p ${OBJECTDIR}/sorting
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sorting/selection_sort.o sorting/selection_sort.cpp
